        ...
        <div className="w-full max-w-sm">
          ...
          {!sent ? (
            <>
              ...
              <button onClick={sendOtp} disabled={loading || !email.trim()} className="btn-primary w-full disabled:opacity-40">
            ...
            <>
              ...
              />
              {error && <p className="text-xs text-red-600 mb-4">{error}</p>}
              <button onClick={verifyOtp} disabled={verifying || code.length !== 6} className="btn-primary w-full disabled:opacity-40">
