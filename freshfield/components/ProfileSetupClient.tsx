  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <div className="max-w-lg mx-auto px-6 py-16">
        ...
        <p className="text-sm leading-relaxed mb-12" style={{ color: '#5a5855' }}>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div>
            ...
            <div className="flex items-center border-b border-line focus-within:border-ink transition-colors">
              <span className="text-soft text-sm pb-2">freshfield-app.vercel.app/profil/</span>
              <input value={slug} onChange={e => { setSlug(toSlug(e.target.value)); setSlugError('') }}
                onBlur={() => checkSlug(slug)} placeholder="dein-name"
                className="flex-1 bg-transparent py-2 text-sm outline-none placeholder:text-soft" />
            </div>
          ...
          <div>
            ...
            <textarea value={bio} onChange={e => setBio(e.target.value)}
              placeholder="Ein paar Sätze über dich und deine Arbeit." maxLength={300}
          ...
          <div>
            ...
            <input value={website} onChange={e => setWebsite(e.target.value)}
              placeholder="https://deine-website.de" type="url"
          ...
          <button onClick={save} disabled={saving || !name.trim() || !slug.trim() || !!slugError}
